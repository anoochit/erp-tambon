  ...
  <tr>
    <td height="162"  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr >
	  		  <td  height="25" bgcolor="#FFCC99" class="tbETitle">&nbsp; เพิ่ม ข้อมุลบทลงโทษ</td>
  			</tr>
			<tr>
			<td height="130"><table name="add" cellpadding="1" cellspacing="1" border="0" bgcolor="#f4f7f9" width="100%">
			<tr class="bmText_1">
   <td width="31%"><span class="style9">วันที่</span></td>
...
&nbsp; <img src="images/calendar.png" onClick="showCalendar('birthday','DD/MM/YYYY')"   width='19'  height='19' /></span></div></td>
  </tr>
  <tr class="bmText_1">
    <td><span class="style9">รายการ</span></td>
    <td><div><input name="li_st" type="text" id="li_st"  size="40">
    </div></td>
  </tr>
  <tr class="bmText_1">
...
<table  border="0" align="center" cellpadding="1" cellspacing="1"  width="98%">
  <tr>
    <td height="161"  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr >
	  		  <td  height="25" bgcolor="#FFCC99" class="tbETitle">&nbsp; แก้ไข ข้อมูลบทลงโทษ</td>
  			</tr>
			<tr>
 ...
 <tr class="bmText_1">
   <td width="31%"><span class="style9">วันที่</span></td>
    <td width="69%"><div><span class="style9">
      <? ?>
      <input name="date_punish2" type="text" id="date_punish2" value="<? if($birthday =='') echo date("d/m/Y") ;else echo $birthday;?>"  size="10" />
&nbsp; <img src="images/calendar.png" onClick="showCalendar('birthday','DD/MM/YYYY')"   width='19'  height='19' /></span></div></td>
  </tr>
  <tr class="bmText_1">
    <td><span class="style9">รายการ</span></td>
    <td><div>
      <input name="li_st" type="text" id="li_st" value="<?=$rs[li_st]?>"  size="40">
    </div></td>
  </tr>
  <tr class="bmText_1">
   <td><span class="style9">เอกสารอ้างอิง</span></td>
    <td><div>
      <input name="refer" type="text" id="refer" value="<?=$rs[refer]?>"  size="40">
    </div></td>
  </tr>

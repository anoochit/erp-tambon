...
<table  border="0" align="center" cellpadding="1" cellspacing="1"  width="98%">
  <tr>
    <td height="198"  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr >
	  		  <td  height="25" bgcolor="#FFCC99" class="tbETitle">&nbsp; เพิ่ม ข้อมุลบุตร</td>
  			</tr>
			<tr>
			<td height="166"><table name="add" cellpadding="1" cellspacing="1" border="0" bgcolor="#f4f7f9" width="100%">
			<tr class="bmText_1">
   <td width="31%"><span class="style9">ชื่อ-สกุล</span></td>
    <td width="69%"><div>
      <input name="name" type="text" id="name" value="" size="50" maxlength="100" />
    </div></td>
  </tr>
  <tr class="bmText_1">
   <td width="31%"><span class="style9">วันเกิด</span></td>
  ...
  <tr class="bmText_1">
    <td><span class="style9">สถานศึกษา</span></td>
    <td><div><input name="lyceum" type="text" id="lyceum"  size="40">
    </div></td>
  </tr>
  <tr class="bmText_1">
   <td><span class="style9">ที่ทำงาน</span></td>
    <td><div>
...
<table  border="0" align="center" cellpadding="1" cellspacing="1"  width="98%">
  <tr>
    <td height="200"  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr >
	  		  <td  height="25" bgcolor="#FFCC99" class="tbETitle">&nbsp; แก้ไข ข้อมูลบุตร</td>
  			</tr>
			<tr>

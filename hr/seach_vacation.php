...
<table width="60%" border="1" cellspacing="0" cellpadding="3" align="center">
  <tr class="bmText">
    <td width="33%" height="30"><strong>&nbsp;&nbsp;ชื่อพนักงาน</strong></td>
    <td width="67%">&nbsp;<input name="name" type="text" id="name" value="<?=$name?>" size="30"></td>
  </tr>
  <tr class="bmText">
    <td height="30"><strong>&nbsp;ประเภทการลา</strong></td>
    <td>&nbsp;
      <select name="leave_type">
        <option value='0' <? if($leave_type ==0) echo "selected"?>>----------กรุณาเลือก----------</option>
        <option value='ลาป่วย' <? if($leave_type =='ลาป่วย') echo "ลาป่วย"?>>ลาป่วย</option>
...
and p.user_id = v.user_id and c.rd_id = rd.rd_id and c.o_id = o.o_id  ";
...
<tr class="lgBar">
      <td  height="28" colspan="6"><div  align="left">&nbsp;&nbsp;เพิ่ม  แก้ไข / ลบ ข้อมูลการลา </div></td>
          </tr>
...
?>       
<a href="?action=add_service&c_id=<?=$rs[c_id]?>"  >

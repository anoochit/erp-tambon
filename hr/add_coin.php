...
if($Go <> ''){
		...
		$sql = "INSERT INTO coin (user_id , co_date,detail, remark) 
		VALUES('$user_id' , '".date_format_sql($co_date)."' , '$detail' , '$remark' )";
...
if($Go_1 <> ''){
		...
		$sql_order = "UPDATE coin SET co_date ='".date_format_sql($co_date)."' ,detail ='$detail' ,remark ='$remark' 
		where co_id ='$co_id' ";
		echo $sql_order."<br>";
  ...
  <tr>
    <td  colspan="2" style="border: #ff9966 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr >
	  		  <td  height="25" bgcolor="#ff9966" class="tbETitle">&nbsp; เพิ่ม ข้อมูลการรับเหรียญพระราชทาน</td>
  			</tr>
			<tr>
   ...
   <td width="31%" class="style5" >&nbsp;วันที่</td>
    <td width="69%"><div class="style2"><input name="co_date" type="text" id="co_date" 
	value="<? echo date("d/m/Y");?>"  size="10"/>&nbsp;<img src="images/calendar.png" onClick="showCalendar('co_date','DD/MM/YYYY')"   width='19'  height='19'>
                  </div></td>
  </tr>
  <tr class="tbETitle_1">
   <td><span class="style5">&nbsp;รายละเอียด</span></td>
    <td><div class="style6" ><input type="text" name="detail" value="<?=$detail?>" size="40">
		</div></td>
...
<? }elseif($action=='edit'){?>
<?
$sql = "SELECT * FROM coin WHERE co_id= $co_id";
$result=mysql_query($sql);
...
<table  border="0" align="center" cellpadding="1" cellspacing="1"  width="98%">
  <tr>
    <td  colspan="2" style="border: #ff9966 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr >
	  		  <td  height="25" bgcolor="#ff9966" class="tbETitle">&nbsp; แก้ไข ข้อมูลการรับเหรียญพระราชทาน</td>
  			</tr>
			<tr>
			<td><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#ffcc99" class="calDay" name="add">
			<tr class="tbETitle_1">
   <td width="31%" class="style5" >&nbsp;วันที่</td>
    <td width="69%"><div class="style2"><input name="co_date" type="text" id="co_date" 
	value="<? if($rs[co_date] =='') echo date("d/m/Y") ;else echo date_format_th($rs[co_date]);?>"  size="10"/>&nbsp; <img src="images/calendar.png" onClick="showCalendar('co_date','DD/MM/YYYY')"   width='19'  height='19'>
                  </div></td>
  </tr>
  <tr class="tbETitle_1">
   <td><span class="style5">&nbsp;รายละเอียด</span></td>
    <td><div class="style6" >
		<input type="text" name="detail" value="<?=$rs[detail]?>" size="40">

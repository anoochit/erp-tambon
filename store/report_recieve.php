...
<tr class="bmText">
	...
	<td  class="lgBar1" height="25"  >
		<div > <img src="images/Search.png" align="absmiddle">&nbsp;&nbsp;&nbsp;รายงานทะเบียนรับพัสดุ</div>	</td>
	</tr>
</table>	</td>
	</tr>
 <tr class="bmText">
...
<tr class="bmText" bgcolor="<? echo $bg?>" onmouseover= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
 ...
 <td  align="center"><font size="2">&nbsp;<?  if ($rs[date_receive] <>'0000-00-00') echo date_2($rs[date_receive]);  ?></font></td>                                              
 <td   align="left"><font size="2"><?=code_1($rs[r_id1])?>&nbsp;</font></td>                                 
 <td  >&nbsp;<font size="2"><?=$rs[remark]?></font></td>
 <td  align="center"><a href="?action=view_detail_1&r_id=<?=$rs[r_id1]?>&rd_id=<?=$rs[rd_id1]?>"   target="_blank">รายละเอียด</a></td></tr>

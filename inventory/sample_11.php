		...
		if (trim($n_file) <> "" and  $n_file_size <= 2000000) { // แทรกไฟล์
			...
			if ($news["pic"] <> "") {
				...
				//echo "ทำการลบไฟล์ : ".$news["pic"]."<br>\n";
					...
					$query="UPDATE code SET pic='$n_file' ,serial ='".$serial."',num_machine ='".$num_machine."'
						,num_box ='".$num_box."',num_stamp ='".$num_stamp."',colour ='".$colour."',remark ='".$remark."' ,screen = '$screen'
						, sale_date =  '".date_format_sql($sale_date)."'  ,sale_way = '$sale_way' ,sale_num = '$sale_num' ,sale_price = '$sale_price' ,sale_benefit = '$sale_benefit' WHERE c_id='$c_id' LIMIT 1";
					echo $query."<br>";
					$result=mysql_query($query);	
		}else {	
...
<tr class="bmText"  >
<td width="38%"  height="30" ><div align="center" class="style2">
  <div align="left"><b>เลขครุภัณฑ์ที่</b></div>
</div></td>
	<td width="62%" height="30"><div align="left" class="style2">&nbsp;
	<?=$rs1[code]?>  
    </div></td>
</tr>
...
<tr class="bmText">
	...
	<td height="30"><div align="left" class="style2">
	      <div align="left">
	        <input  type="text" name="sale_price" value="<?=$rs1[sale_price]?>" >
	        </div>
	</div></td>
	</tr>
	<tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
<tr class="bmText">
	  ...
	  <td height="30"><div align="left" class="style2">
	    ...
	    <div align="left">
	      <input  type="text" name="sale_benefit" value="<?=$rs1[sale_benefit]?>" size="30"  >
	        </div>
	  </div></td>
	  </tr>
	  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>

  ...
  <tr>
    <td  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="85%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr class="lgBar">
	  		  <td  height="25" >&nbsp; ทะเบียนอสังหาริมทรัพย์</td>
  			</tr>
			<tr>
...
<a href="#" onClick="javascript:popup('add_new_p.php?action=add&OK=OK','',750,300);">เพิ่มรายการ
</a>
</center>
<br>
		<br>
                                            ...
                                            <tr>
											  ...
											  <table width="100%" align="center" cellspacing="1" border="0" style="border-collapse:collapse;">
                                                <tr class="bmText"  bgcolor="#C1E0FF">
                                                  ...
                                                  <td width="14%" height="30" align="center" style="border: #000000 1px solid;">ประเภท</td>
                                                  <td width="20%"  align="center" style="border: #000000 1px solid;">ชื่ออสังหาริมทรัพย์</td>
												
                                                  <td width="14%"   align="center" style="border: #000000 1px solid;">ราคา / หน่วย</td>
											      
                                                  <td width="19%"  align="center" style="border: #000000 1px solid;">ยี่ห้อ ชนิด แบบ ขนาด</td>
											      <td width="17%"  align="center" style="border: #000000 1px solid;">ใช้ประจำที่</td>
												  <td width="11%"  align="center" style="border: #000000 1px solid;">หมายเหตุ</td>

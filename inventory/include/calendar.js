...
function showCalendar(id) {
	...
	if (calendar != null) {
		...
		var date = new Date()
		//var minYear = (date.getFullYear() - 2)+543, maxYear = (date.getFullYear() +10) + 543;
		var minYear = (date.getFullYear() - 2), maxYear = (date.getFullYear() +10);
...
Calendar = function (mondayFirst, dateStr, onSelected, onClose) {
	...
	this.dragging = false;
	this.hidden = false;
	this.minYear = (date.getFullYear() - 2);
	this.maxYear = (date.getFullYear() +10) ;
	//this.minYear = (date.getFullYear() - 2)+543;
	//this.maxYear = (date.getFullYear() +10) + 543;

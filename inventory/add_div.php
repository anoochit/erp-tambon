...
if($save_add <> ''){
	if( find_div_id($div_name) <=0){
		$query=" INSERT INTO division (div_id,div_name)
		 VALUES ('$div_id','$div_name')";
		echo $query."<br>";
...
if($save_add_sub <> ''){
	if( find_sub_name($no_book,$sub_name) <=0){
...
<tr>
  <td  align="right" width="40%"   class="style5">
  รหัสกอง</td>
	<td align="left">&nbsp;&nbsp;
	  <input type="text" name="div_id1" value="<?=$div_id?>" size="20"  maxlength="5"  disabled="disabled"/>
	  <input type="hidden" name="div_id" value="<?=$div_id?>">
	  </td>
</tr>
<tr>
  <td a align="right" width="40%"   class="style5">ชื่อกอง</td>
	<td align="left">&nbsp;&nbsp;
...
<table width="90%" border="0" cellspacing="1" cellpadding="1" align="center" >
  <tr>
	...
	<tr>
 <td a align="right" width="40%"  class="style5">
    ชื่อกอง  
  </div>
  <td align="left">
&nbsp;&nbsp;
...
<tr>
    <td  align="right" width="40%"  class="style5">รหัสฝ่าย</div></td>
  <?
...
<tr>
  <td a align="right" width="40%"  class="style5">ชื่อฝ่าย</div></td>
	<td align="left">&nbsp;&nbsp;

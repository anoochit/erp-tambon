...
<br><br>
<table width="1200"   border="1"align="center" cellspacing="0"  cellpadding="0" >
 <tr class="lgBar"  bgcolor="#C1E0FF">
  <td width="2%"  height="31"><div align="center"> <b><span style="font-size:9pt;"><font face="tahoma">NO.</font></span></b> </div></td>
<td width="7%"  height="31"><div align="center"> <b><span style="font-size:9pt;"><font face="tahoma">วัน เดือน ปี</font></span></b> </div></td>
      ...
      <td width="3%"  align="center"><b><span style="font-size:9pt;"><font face="tahoma">จำนวน</font></span></b></td>
 <td width="4%"  align="center"><b><span style="font-size:9pt;"><font face="tahoma">หน่วยนับ</font></span></b></td>
  <td width="4%"  align="center"><b><span style="font-size:9pt;"><font face="tahoma">ราคา</font></span></b></td>
   <td width="11%"  align="center"><b><span style="font-size:9pt;"><font face="tahoma">กอง / ฝ่าย </font></span></b></td>
    <td width="10%"  align="center"><b><span style="font-size:9pt;"><font face="tahoma">ใบเบิก</font></span></b></td>
    <td width="14%"  align="center"><b><span style="font-size:9pt;"><font face="tahoma">สถานะ</font></span></b></td>
	 <td width="12%"  align="center"><b><span style="font-size:9pt;"><font face="tahoma">หมายเหตุ</font></span></b></td>
    </tr>
<?
$i = 0;
$j =0;
...
<td  height="25"  align="center"><font style="font-size:9pt;">&nbsp;<? echo $i; ?></font></td>
 ...
 <td align="left"><font style="font-size:9pt;">&nbsp;<? echo shop_name($rs[shop_id]); ?></font></td><? 
		...
		$bb = $d[3];
//echo $rs[code];  ?>
<td width="8%"  align="center"><font style="font-size:9pt;">&nbsp;<?=$aa;?></font> </td>
<td width="8%"   align="left"><font style="font-size:9pt;"><?=$bb;?>&nbsp;</font> </td>
...
if($rs[num_id] <>'') echo $rs[num_id].",".$rs[paper_id]?>&nbsp;</font></td>
<td  align="left"><font style="font-size:9pt;" ><input  type="radio" name="status[<?=$i?>]" value="0" <? if($rs[status]==0 or $status[$i] == 0) echo "checked"?>>&nbsp;<font color="<? 
if($rs[status]==0 or $status[$i] == 0) echo "#0000FF";
else echo "#000000";
?>">ใช้งานอยู่</font><br>
<input  type="radio" name="status[<?=$i?>]" value="1" <? if($rs[status]==1 or $status[$i] == 1) echo "checked"?>>&nbsp;<font color="<? 
if($rs[status]==1 or $status[$i] == 1) echo "#009900";
else echo "#000000";
?>">รอจำหน่าย</font><br>
<input type="radio" name="status[<?=$i?>]" value="2" <? if($rs[status]==2 or $status[$i] == 2) echo "checked"?>>&nbsp;<font color="<? 
if($rs[status]==2 or $status[$i] == 2) echo "#FF0000";
else echo "#000000";
?>">จำหน่ายแล้ว</font><br>
</font></td>
<td  align="center"><font style="font-size:9pt;"><input type="text" name="remark[<?=$i?>]" value="<? 
if ($rs["remark"] <>'') {
	echo $rs["remark"];
}else{
	echo $remark[$i];
...
<div align="center"><br>
  <input   type="submit" name='save' value="บันทึก"   onclick="return q_confirm();">&nbsp;&nbsp;
	 <input   type="button"  name='cancel' value="ยกเลิก"  onclick="javascript:window.close();">
	 <br><br>
    ...
    <input  type="button" name="print" value=" พิมพ์ excel "  onClick="window.open('seach_all_show_print.php?search=<?=$search?>&code1=<?=$code1?>&rd_name=<?=$rd_name?>&div_id=<?=$div_id?>&sub_id=<?=$sub_id?>&open_date=<?=$open_date?>&open_date1=<?=$open_date1?>&type=<?=$type?>&status=<?=$status?>')"/> 
</div>			  
</form>

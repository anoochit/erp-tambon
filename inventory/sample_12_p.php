...
if($Go <> ''){
		$m_id = find_max_m_id();
		$sql_order = "INSERT INTO move_p (year,department,name_head,remark,user,rd_id , m_id) 
		VALUES('$year','$department','$name_head','$remark','$user' , '$rd_id' , '$m_id')";
		echo $sql_order."<br>";
...
if($Go1 <> ''){
		...
		$sql_order = "UPDATE move_p SET year = '$year' ,department = '$department',name_head = '$name_head',remark ='$remark'
...
<table  border="0" align="center" cellpadding="1" cellspacing="1"  width="98%">
  ...
  <tr class="bmText_1">
    ...
    <td><div><input name="department" type="text"  size="40" value="<?=$department?>"></div></td>
  </tr>
    <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
  <tr class="bmText_1">
...
<? }elseif($tab=='edit'){
$sql = "SELECT * FROM move_p WHERE m_id= $m_id ";
...
<table  border="0" align="center" cellpadding="1" cellspacing="1"  width="98%">
 ...
 <tr class="bmText_1">
  ...
  <tr class="bmText_1">
    <td>ชื่อส่วนราชการ</td>
    <td><div><input name="department" type="text"  size="40" value="<?=$rs[department]?>"></div></td>
  </tr>
      <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
  <tr class="bmText_1">
    <td>ชื่อผู้ใช้พัสดุ</td>
...
<?
	function find_max_m_id() {
		...
		$sql = "Select max(m_id) as max  from move_p  ";
		$result = mysql_query($sql); 

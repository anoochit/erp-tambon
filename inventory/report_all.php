...
<body><br>
<form name="f12" method="post"  action="report_all_show.php"   target="_blank" >
...
<tr class="bmText">
  ...
  <tr class="bmText">
    <td height="28"><strong>&nbsp;&nbsp;วันที่รับ</strong></td>
  ...
  <tr class="bmText">
    ...
    <td><div>&nbsp;<input type="text" name="code1" value="<?=$code1?>" size="30"></div></td>
  </tr>
  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
  <tr class="bmText">
    <td height="30"><strong>&nbsp;&nbsp;หมวด</strong></td>
              <td width="78%" align="left"><div>&nbsp;<select name="cat" onChange="dochange('type_', this.value)" >
<option value="0" <? if($cat == 0) echo "selected"?>>สังหาริมทรัพย์</option>
<option value="1" <? if($cat == 1) echo "selected"?>>อสังหาริมทรัพย์</option>
</select></div>
</td>
            </tr>
<tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
  <tr class="bmText" height="25">
                    ...
                    <td><div id='type_'>&nbsp;<?
			$query  ="select * from type where type_id = '$cat'  group by type_name  order by type_id";

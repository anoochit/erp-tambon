...
<tr class="bmText">
	...
	<td  class="lgBar1" height="25"  >
		<div > <img src="images/Search.png"  align="absmiddle">&nbsp;&nbsp;ทะเบียนอสังหาริมทรัพย์ &nbsp;&nbsp; [ <a href="?action=new_buy_1_p" class="catLink">เพิ่มทะเบียนอสังหาริมทรัพย์</a>]</div>	</td>
	</tr>
</table>	</td>
	</tr>
  <tr class="bmText">
    <td width="38%" height="30"><strong>&nbsp;&nbsp;ทะเบียนเลขที่รับ</strong></td>
    <td width="62%">&nbsp;<input type="text" name="paper_id" value="<?=$paper_id?>" size="30"></td>
  </tr>  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
  <tr class="bmText">
    <td height="30"><strong>&nbsp;&nbsp;วันที่ได้กรรมสิทธิ์</strong></td>
...
<tr class="lgBar">
      <td  height="28" colspan="5" style="border: #000000 1px solid;" ><div  align="left">&nbsp;&nbsp;แก้ไข / ลบ ทะเบียนอสังหาริมทรัพย์</div></td>
          </tr>
  <tr class="bmText"  bgcolor="#C1E0FF">
		...
		<td width="14%"  height="31" style="border: #000000 1px solid;" ><div align="center"><strong>ทะเบียนเลขที่รับ</strong></div></td>
         <td width="16%" style="border: #000000 1px solid;" ><div align="center"><strong>วันที่ได้กรรมสิทธิ์</strong></div></td>
         <td width="37%" style="border: #000000 1px solid;" ><div align="center"><strong>ชื่ออสังหาริมทรัพย์ </strong></div></td>
		 <td width="19%" style="border: #000000 1px solid;" ><div align="center"><strong>ใช้ประจำที่</strong></div></td>
        <td width="14%" style="border: #000000 1px solid;" >&nbsp;</td>
          </tr>
<?
$i = 0;
if($result1)
...
?>       
<a href="?action=view_detail_1_p&r_id=<?=$rs[r_id1]?>&rd_id=<?=$rs[rd_id]?>"  > 
<tr class="bmText" bgcolor="<? echo $bg?>" onmouseover= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#FFCC00'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
 ...
 <td  style="border: #000000 1px solid;" ><div align="left"><font size="2">&nbsp;<?=$rs[rd_name];?></font></div></td>
  <td  style="border: #000000 1px solid;" ><div align="left"><font size="2">&nbsp;<?=$rs[garan_at];?></font></div></td>
    <td  style="border: #000000 1px solid;" ><div  align="center"><font size="2"><a href="?action=view_detail_1_p&r_id=<?=$rs[r_id1]?>&rd_id=<?=$rs[rd_id]?>"  > รายละเอียด</a></font></div></td> </tr>
</a>
 <? 
	}
?>

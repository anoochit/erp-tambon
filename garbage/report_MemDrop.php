...
<table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
<tr class="lgBar">
      <td  height="28" colspan="14"><div  align="left">&nbsp;&nbsp;รายงานรายชื่อผู้ยกเลิกใช้บริการจัดเก็บขยะมูลฝอย</div></td>
        </tr>
  <tr class="bmText"  bgcolor="#DEE4EB">
		...
		<td width="13%"  height="31" align="center"><p><strong>เลขทะเบียน</strong><strong></strong></p></td>
         <td width="18%"  align="center"><p><strong>วันที่ขอหยุดใช้</strong></p></td>
...
<td width="40%"  height="25"  align="left"><strong>&nbsp;&nbsp;จำนวนผู้ขอยกเลิก :: &nbsp; <?=$i ?> &nbsp; ราย</strong></td>
<td width="60%"  height="25"  align="left"><strong>&nbsp;&nbsp;รวมเป็นเงิน :: &nbsp; <?=number_format($total_qty) ?> &nbsp; บาท</strong></td> 
</tr>
</table>	
	  </td>
    </tr>
...
<div align="center">
<input  type="button" name="print" value=" พิมพ์ "  onclick="window.open('report13.php?month=<?=$month?>&year=<?=$year?>&hocode=<?=$HOCODE ?>&honame=<?=$d[HONAME]?>')"/ class="buttom">
</center></div> 
</body>
</html>
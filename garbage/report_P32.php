...
?>
<td width="7%"  height="31" align="center" style="border: #7292B8 1px solid;" ><strong>
หมู่ที่ <?=$hocode?>
</strong></td>
<? }
?>
...
?>
 <tr class="bmText" >
        ...
        <td  height="25"   align="right"style="border: #7292B8 1px solid;" ><font size="1"><strong><?=number_format($rs1[stotal])?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
<? 
...
?>
      ...
      <tr class="bmText" bgcolor="#DEE4EB"  onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe' " onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = '' ">
        ...
        <td  height="25"   align="right" style="border: #7292B8 1px solid;" ><strong><?=number_format($SumMtotal)?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
 <? 

	...
	<td  class="lgBar" height="25"  >
		<div > <img src="images/Search.png" align="absmiddle">&nbsp;&nbsp;&nbsp;ทะเบียนผู้ขอใช้บริการ</div>	</td>
	     ...
	     <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
			...
			<td width="27%"><strong>&nbsp;&nbsp;หมู่บ้าน</strong></td>
                    <td  ><div><?
...
<tr class="lgBar">
  ...
  <tr class="bmText"  bgcolor="#DEE4EB">
		...
		<td width="21%"  height="31" align="center"><strong>ชื่อ - สกุล</strong></td>
		 ...
		 <td width="11%"  align="center"><strong>ราคา</strong></td>
...
<? /* สร้างปุ่มย้อนกลับ */
if($Prev_Page) 
echo " <a href='?action=find_mem&search=$search&Page=$Prev_Page&mcode_1=$mcode_1&mcode_2=$mcode_2&name=$name&surn=$surn&HOCODE=$HOCODE'><< ย้อนกลับ </a>";

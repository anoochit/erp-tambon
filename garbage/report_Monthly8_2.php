...
<tr class="header">
      <td  height="28" colspan="14"><div  align="left">&nbsp;&nbsp;ข้อมูลบิลค้างชำระ หมู่ที่   <?=$hocode."    " .$honame?>   ประจำเดือน&nbsp;
        <?=mounth3($month)."  ".$year?>
      </div></td>
          </tr>
  <tr class="body1"  bgcolor="#DEE4EB">
		...
		<td width="23%"  height="31" align="center"><p><strong>ชื่อ - สกุล</strong></p>		  </td>
         <td width="8%"  align="center"><strong>บ้านเลขที่</strong></td>
		 <td width="10%"  align="center"><strong>เลขที่บิล</strong></td>
		 <td width="8%"  align="center"><strong>จำนวนเงิน</strong></td>
         <td width="17%"  align="center"><p><strong>วันที่ออก</strong></p>
           <p><strong>ใบเสร็จ</strong></p></td>
    <td width="9%"  align="center"><p><strong>ประจำเดือน</strong><strong></strong></p>      </td> 
          </tr>
<?
if($Page >= 2 ){
			$i=$Page_start ;

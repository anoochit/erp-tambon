...
<?
if($save_add <>'' ){
		if(check_edit_mooban($hocode,$honame) <=0){
		// แก้ไข   user
   $sql_user=" UPDATE house SET   honame = '$honame' where hocode ='$hocode'  ";
	...
	echo "<br><br><center><font color=darkgreen>กรุณารอสักครู่ระบบกำลังทำการแก้ไขข้อมูล</font></center><br><br>";
     print "<meta http-equiv=\"refresh\" content=\"1;URL=?action=mooban\">\n";
		...
		echo "<br><br><center><font color=darkgreen>ชื่อหมู่บ้านซ้ำกรุณาบันทึกข้อมูลใหม่</font></center><br><br>";
	}
}
//-----------เรียกข้อมูล-------------------
...
<tr class="bmText">
  <td a align="right" width="37%"  >หมู่ที่</td>
	<td width="63%" align="left">&nbsp;&nbsp;
	  <input type="text" name="hocode1" value="<?=$d[HOCODE]?>" size="10" maxlength="100"  disabled="disabled" />
	  <input  type="hidden" name="hocode" value="<?=$d[HOCODE]?>" size="20"  />
	  </td>
</tr>
...
<tr class="bmText">
  <td a align="right" width="37%"  >ชื่อหมู่บ้าน</td>
	<td align="left">&nbsp;&nbsp;
	  <input  type="text" name="honame" value="<?=$d[HONAME]?>" size="20" maxlength="50"  /></td>
</tr>
  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
<tr>

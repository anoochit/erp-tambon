 ...
 <table  width="100%"   border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td  colspan="2"><table width="100%" align="center" cellspacing="0"  cellpadding="0" border="1"  bordercolor="#666666">
      <tr class="header">
        <td  height="28" colspan="14" bgcolor="#DEE4EB"><div  align="left">&nbsp;&nbsp;<strong>รายงานสรุปยอดตั้งเก็บและจัดเก็บได้ค่าธรรมเนียมขยะมูลฝอยประจำปี <? echo $year;?></strong> </div></td>
      </tr>
...
<tr class="body1" bgcolor="<? echo $bg?>" onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
 ...
 ?>
      ...
      <tr class="body1" bgcolor="#DEE4EB"  onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe' " onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = '' ">
        ...
        <td  height="25"   align="center"><strong>&nbsp;<?=number_format($SumB)?></strong></td>
        <td  height="25"  align="center"><strong>&nbsp;<?=number_format($SumC)?></strong></td>
        <td  align="center"><strong>&nbsp;<?=number_format($SumD)?></strong></td>
		<td  align="center"><strong>&nbsp;<?=number_format($SumE)?></strong></td>
        <td  align="center"><strong>&nbsp;<?=number_format($SumF)?></strong></td>
        <td  align="center"><strong>&nbsp;<?=number_format($SumG)?></strong></td>
        <td  align="center"><strong>&nbsp;<?=number_format($SumH)?></strong></td>

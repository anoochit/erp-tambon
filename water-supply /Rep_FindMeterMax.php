...
<tr class="bmText">
  ...
  <tr class="bmText" height="25">
                    <td width="25%"><strong>&nbsp;&nbsp;หมู่บ้าน</strong></td>
                    <td width="75%"><div><?
	...
	<tr class="bmText" height="25">
                    <td width="25%"><strong>&nbsp;&nbsp;เขต</strong></td>
                    <td width="75%"><div id = "ZONE">
                      <?
		if($HOCODE ==''){
  ...
  <?
	...
	?>
		...
		<? }?>
				  ...
				  <tr class="bmText" height="25">
			<td width="25%"><strong>&nbsp;&nbsp;เดือน</strong></td>
                    <td  ><div><strong>
                      <select name="month" >
	...
	?>
				  ...
				  <tr class="bmText" height="25">
                    <td width="25%"><strong>&nbsp;&nbsp;จำนวนหน่วยที่สูงกว่า</strong></td>
                    <td width="75%"><div><input name="unit" type="text" id="unit" width="70" value="<?=$unit?>">
                    <strong>&nbsp;&nbsp;หน่วย</strong></div> </td>
          </tr>
				  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
				  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
    <td colspan="2" align="center" height="34"><input   type="submit"  name="search" value=" ค้นหา "  class="buttom"></td>
  </tr>
</table>
</td></tr></table>
<br>
...
<table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
<tr class="lgBar">
      <td  height="28" colspan="14"><div  align="left">&nbsp;&nbsp;รายงานตรวจสอบเลขมาตรสูงกว่า&nbsp;<?=$unit?>&nbsp;หน่วย</div></td>
        </tr>
...
$sql_1= "Select  q.MCODE,concat(pren,name,'  ',surn) as name,moo,q.mno,HNO1,HNO,if(m2.mno is null,'m_total',m2.mno) as M ,
 ...
 if(m_amt is null,'',m_amt)as m_amt,monthh,myear  from member m,q_water q ,meter m2 
 where  q.MCODE = m2.MCODE and q.mem_id = m.mem_id  and amount >'".$unit. "' ";
$ex = substr($month,0,1);
...
<div align="center">
  <input  type="button" name="print" value=" พิมพ์ "  onclick="window.open('report17.php?month=<?=$month?>&year=<?=$year?>&HOCODE=<?=$HOCODE ?>&z_id=<?=$z_id?>&unit=<?=$unit?>')"/ class="buttom">
 </center></div> 
</body>
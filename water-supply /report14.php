...
<tr class="header" bgcolor="#DEE4EB">
      <td  height="28" colspan="14"><div  align="left">&nbsp;&nbsp;รายงานยกเลิกใบเสร็จค่าน้ำประปาประจำเดือน <?=mounth3($month)?>&nbsp;<?=$year?></div></td>
        </tr>
...
$sql_1 ="Select  MCODE,rec_id,if(num_id is null,'',num_id) as num_id,memo  from meter  where p_num > 1

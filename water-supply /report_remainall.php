...
<tr class="bmText">
  ...
  <tr class="bmText" height="25">
	...
	<tr class="bmText" height="25">
                    <td width="16%" height="38"><strong>&nbsp;&nbsp;เขต</strong></td>
...
<table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
<tr class="lgBar">
      <td  height="28" colspan="14"><div  align="left">&nbsp;&nbsp;รายงานข้อมูลใบเสร็จค้างชำระทั้งหมด</div></td>
        </tr>
  <tr class="bmText"  bgcolor="#DEE4EB">
        <td width="7%"  height="31" align="center"><strong>เลขทะเบียน</strong></td>
		<td width="11%"  height="31" align="center"><strong>ชื่อ - สกุล</strong></td>
		<td width="6%"  height="31" align="center"><p><strong>บ้านเลขที่</strong><strong></strong></p></td>
         <td width="3%"  align="center"><p><strong>หมู่</strong></p></td>
         <td width="7%"  align="center"><p><strong>เลขมาตร</strong></p></td>
		 <td width="6%"  align="center"><p><strong>มาตรเดิม</strong></p></td>
		 <td width="6%"  align="center"><p><strong>ปัจจุบัน</strong></p></td>
		 ...
		 <td width="7%"  align="center"><p><strong>ภาษี</strong></p></td>
		  <td width="7%"  align="center"><p><strong>ค่าเช่ามาตร</strong></p></td>
		 <td width="6%"  align="center"><p><strong>รวมทั้งสิ้น</strong></p></td>
		 <td width="13%"  align="center"><p><strong>เลขที่ใบเสร็จ </strong></p></td>
...
$sql_1="Select  q.MCODE,concat(pren,name,'  ',surn) as name,moo,q.mno,HNO1,HNO,if(m2.mno is null,'m_total',m2.mno) as M ,
 if(rec_id is null,'',rec_id)as rec_id,if(rec_status is null,'ค้างชำระ',rec_status)as rec_status,rec_date,p_date,if(amount is null,'',amount)as amount ,
...
$sql_1.=" and rec_status = 'ค้างชำระ' order by rec_id ";
...
?>
  <tr class="bmText"  bgcolor="#DEE4EB">
		...
		<td width="11%"  height="25" align="center"><strong>&nbsp;<? echo number_format($i); ?>&nbsp;&nbsp;&nbsp;รายการ </strong></td>
...
<div align="center">
  <input  type="button" name="print" value=" พิมพ์ "  onclick="window.open('report15.php?month=<?=$month?>&year=<?=$year?>&HOCODE=<?=$HOCODE ?>&z_id=<?=$z_id?>')"/ class="buttom">
 </center></div> 
</body>
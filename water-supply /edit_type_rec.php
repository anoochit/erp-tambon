...
if($save_add <>'' ){
   ...
   $sql_user=" UPDATE type_rece SET   TRNAME = '$TRNAME' where TRCODE ='$TRCODE'  ";
  ...
  <tr>
    <td  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr class="lgBar">
  		  		<td  height="25" colspan="2"><div>&nbsp;&nbsp;&nbsp;แก้ข้อมูลประเภทรายรับ</div></td>
  			</tr>
...
<tr class="bmText">
  <td a align="right" width="37%"  >ชื่อประเภทรายรับ</td>
	<td align="left">&nbsp;&nbsp;

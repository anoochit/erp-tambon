...
<table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
<tr class="lgBar">
      <td  height="28" colspan="14"><div  align="left">&nbsp;&nbsp;รายงานรายชื่อผู้ใช้บริการน้ำประปา</div></td>
        </tr>
...
,if(rec_id is null,'',rec_id) as rec_id,if(amount is null,'',amount)as amount ,if(m2.m_date is null,'',m2.m_date) as m_daterec_id,
rec_date,amount , m_date,if(m_rate is null,'',m_rate)as m_rate,if(m_amt is null,'',m_amt)as m_amt
...
<div align="center">
  <input  type="button" name="print" value=" พิมพ์ "  onclick="window.open('report11.php?month=<?=$month?>&year=<?=$year?>&HOCODE=<?=$HOCODE ?>&z_id=<?=$z_id?>')"/ class="buttom">
 </center></div> 
</body>
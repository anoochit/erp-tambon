...
if($search <>'' and ($nsurn <>''or $MCODE <>'' or  $rec_id <>'') ){
			...
			if($MCODE <> '') $sql_ex  .=  "   and q.MCODE    like   '" .$MCODE. "'   ";
			if($rec_id <> '') $sql_ex  .=  "  and rec_id  like     '" .$rec_id. "'   ";
			
			$sql_ex  .=  "  order by q.MCODE   ";
			$Per_Page = 20;
			if(!$Page){$Page=1;} 
			$Prev_Page = $Page-1;
			$Next_Page = $Page+1;
...
<table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
  <tr class="bmText"  bgcolor="#DEE4EB">
		...
		<td width="15%"  height="31" align="center"><strong>ชื่อ - สกุล</strong></td>
		<td width="7%"  height="31" align="center"><strong>บ้านเลขที่</strong>		</td>
         <td width="23%"  align="center"><strong>ข้อมูลใบเสร็จ</strong></td>
		 <td width="9%"  align="center"><p><strong>สถานะ</strong></p></td>
    <td width="9%"  align="center"><p><strong>วันที่รับเงิน</strong></p></td> 
 ...
 <td width="4%"  align="center"><p><strong>แก้ไข</strong></p></td> 
          </tr>
<?
if($Page >= 2 ){
			$i=$Page_start ;
...
&nbsp;รวมเงิน&nbsp; <font color="#FF0000">:    <strong><? echo number_format($rs_1[sum_m],2)?></strong></font> บาท<br>
 ...
 <td align="center" > &nbsp; <?  echo $rs_1[M];?>     </td>
   <td align="center" ><a href="#" onClick="javascript:popup('add_edit.php?MCODE1=<?=$rs_1[MCODE]?>&rec_id1=<?=$rs_1[rec_id]?>','',600,500)"> <img  src="images/pencil_16.png"border="0" /></a></td>
</tr>
 <? 
	}
?>

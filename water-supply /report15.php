  ...
  <tr>
    <td  colspan="2" ><table width="100%" align="center" cellspacing="0"  cellpadding="0" border="1" bordercolor="#666666">
      <tr class="body1" bgcolor="#DEE4EB">
        <td  height="28" colspan="14"><div  align="left"><strong>&nbsp;&nbsp;รายงานข้อมูลใบเสร็จค้างชำระทั้งหมด</strong></div></td>
      </tr>
      <tr class="body1"  bgcolor="#DEE4EB">
...
?>
      <tr class="body1"  bgcolor="#DEE4EB">
        ...
        <td width="16%"  height="25" align="center"><strong>&nbsp;<? echo number_format($i); ?>&nbsp;&nbsp;&nbsp;รายการ </strong></td>

...
<table width="95%" border="0" cellspacing="1" cellpadding="1" align="center"  bgcolor="#DEE4EB">
  <tr>
    <td align="center" colspan="2" style="border: #999999 1px solid;">
<table width="100%" border="0">
	<tr align="left">
	<td  class="header" height="25"  >
		<div >รายงานสรุปจัดเก็บค่าธรรมเนียมน้ำประปาประจำเดือน <?=mounth3($month)." ".$year?> หมู่ <?=$HOCODE." ".$HONAME?> </div>	</td>
	</tr>
</table></td>
</tr>
</table> 
...
$stotal6 = 0;
$stotal7 = 0;
$sql_1="select mid(mcode,3,1) as mcode, z_name, sum(sum_m)as stotal ,count(rec_id)as num1 
from meter, zone z where rec_status is not null and rec_status <> 'ยกเลิก' and hocode = mid(mcode,1,2)
	and hocode =" .$HOCODE." and z_id = mid(mcode,3,1) and myear = '" .$year. "' and monthh = ".$month."
...
while($rs_1=mysql_fetch_array($result_1)){
		...
		//////////////////////////////ยอดเก้บได้คงค้าง//////////////////////////////////////////
				$sql2=" select count(rec_id),if(sum(sum_m) is null,'0',sum(sum_m)) as  stotal2 from zone left join meter m  on z_id = mid(mcode,3,1)  and hocode = mid(mcode,1,2)
		...
		////////////////////////////////////เลขที่ใบเสร็จตั้งต้น////////////////////////////////////
		  ...
		  ///////////////////////////////เลขตั้งแต่ -- ถึง//////////////////////////////////////
		   ...
		   ///////////////////////////////จำนวน/////////////////////////////////////////
			...
			?>
 <tr class="body1" bgcolor="#FFFFFF" onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">

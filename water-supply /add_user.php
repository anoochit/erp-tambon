...
<tr class="bmText">
  <td a align="right" width="40%"  >Username</td>
	<td align="left">&nbsp;&nbsp;
	  <input type="text" name="username1" value="<?=$username1?>" size="20" maxlength="100" class="text" /></td>
</tr>
  <tr class="bmText"><td colspan="2" background="images/hdot2.gif"> </td></tr>
<tr class="bmText">
  <td a align="right" width="40%"  >Password</td>
	<td align="left">&nbsp;&nbsp;
	  <input type="password" name="password1" value="<?=$password1?>" size="20" maxlength="100"  class="text" /></td>
</tr>
 <tr class="bmText">
...
<tr class="bmText">
  <td a align="right" width="40%"  >RE - Password</td>
	<td align="left">&nbsp;&nbsp;
	  <input type="password" name="re_password" value="<?=$re_password?>" size="20" maxlength="100"  class="text"/></td>
</tr>
  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
  <tr>
  <td  align="right" width="40%"  class="bmText">
  ระดับผู้ใช้งาน</td>
	<td align="left">&nbsp;&nbsp;<select name="pwd_priv1" class="text"  >

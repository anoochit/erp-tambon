...
?>
                    ...
                    <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
                    <td width="302" class="bmText_1"><div> ราคา/หน่วย</div></td>
                    <td><div>
				    ...
				    <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
                  <tr>
                    <td width="302" class="bmText_1"><div> จำนวน </div></td>
                    <td><div>
				    ...
				    <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
                  <tr>
                    <td width="302" class="bmText_1"><div> หน่วยนับ </div></td>
				    ...
				    <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
                  <tr>
                    <td height="30"  align="center" colspan="10"><input type="submit" name="OK" value="ตกลง"   class="buttom" onClick=" return check(this);" >&nbsp;&nbsp;
  ...
  <script language="JavaScript" type="text/javascript">
	function check(theForm) 
	{
		  if (  document.from12.type_id.value=='' || document.from12.type_id.value==' ' )
           ...
           {
          	 alert("กรุณากรอกราคาต่อหน่วย หรือใส่ 0");

...
<body  >
<form name="f166" method="post"  action="?action=new_buy_t1&type_id=<?=$type_id?>"   >
<br>
...
function check_paper_id($year){
		$sql = "Select *  from receive  where paper_id like '%$year%' order by abs(paper_id) desc  limit 1  ";
		$result = mysql_query($sql); 

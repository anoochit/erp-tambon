...
<tr class="bmText">
	...
	<td  class="lgBar1" height="25"  >
		<div ><img src="images/Search.png" align="absmiddle">&nbsp;&nbsp;ตรวจรับ<?=$na?> &nbsp;&nbsp; [ <a href="?action=new_buy_1_t1&type_id=<?=$type_id?>" class="catLink">เพิ่มตรวจรับ<?=$na?></a>]</div>	</td>
	</tr>
</table>
	</td>
	</tr>
...
<tr class="lgBar">
      <td  height="28" colspan="6" align="left">&nbsp;&nbsp;แก้ไข / ลบ ตรวจรับ<?=$na?></td>
          </tr>
  <tr class="bmText"  bgcolor="#DEE4EB">
        <td width="17%"  height="31" align="center"><strong>เลขที่ใบส่งของ</strong></td>
		<td width="16%"  height="31" align="center"><strong>ทะเบียนเลขที่รับ</strong></td>
         <td width="19%" align="center" ><strong>วันที่รับ</strong></td>
         <td width="48%"  align="center"><strong>ชื่อ / จำนวนที่รับพัสดุ <?=$na?></strong></td>
          </tr>
<?
$i = 0;
while($rs=mysql_fetch_array($result1)){
	...
	if($i%2 ==0) $bg ='#e8edff';
	elseif( $i%2 ==1) $bg ='#e8edff';
?>       
<a href="?action=view_detail_t1&r_id=<?=$rs[r_id1]?>&rd_id=<?=$rs[rd_id1]?>&type_id=<?=$type_id?>"  > 

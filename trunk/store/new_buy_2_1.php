...
<form name="f166" method="post"  action="?action=new_buy_2_2"   >
...
<script language="JavaScript" type="text/javascript">
	...
	function check(theForm) 
	{
           ...
           {
           alert("กรุณากรอกทะเบียนเลขที่เบิก");
 	...
 	if (  document.f166.open_name.value=='' || document.f166.open_name.value==' ' )
		 ...
		 if (  document.f166.div_id1.value=='' || document.f166.div_id1.value==' ' )
           {
           alert("กรุณาเลือกหน่วยงานที่เบิก");
           document.f166.div_id1.focus();           
           return false;
           }

  ...
  <tr>
    <td  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1"  bgcolor="#F4F7F9">
 		 	<tr  class="lgBar1" >
  		  		<td  height="25" colspan="4" ><div>รายงานการมาสาย</div></td>
  			</tr>
			    <tr >
                <td width="106" class="style_h"><div> วันที่ </div></td>
	...
	value="<? if($date_late1=='') echo date("d/m/Y"); else echo $date_late1;?>"  size="10"/>
				  ...
				  <td width="104" class="style_h"><div> ถึงวันที่ </div></td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1" align="center"  bordercolor="#FFFFFF">
	...
	<tr  bgcolor="#60c0ff">
		<td  align="center" height="25" width="181"> เลขที่พนักงาน	</td>
		<td  align="center" height="25" width="229"> ชื่อ - สกุล</td>
		<td align="center" height="25" width="170"> วันที่มาสาย</td>
		<td   align="center" height="25" width="137">เวลา</td>
...
<? /* สร้างปุ่มย้อนกลับ */
if($Prev_Page) 
echo " <a href='?action=report_late&Page=$Prev_Page&go_search=$go_search&date_late1=$date_late1&date_late2=$date_late2'><< ย้อนกลับ </a>";
...
/*สร้างปุ่มเดินหน้า */
if($Page!=$Num_Pages)
echo "<a href ='?action=report_late&Page=$Next_Page&go_search=$go_search&date_late1=$date_late1&date_late2=$date_late2'> หน้าถัดไป>> </a>";

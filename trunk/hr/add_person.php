...
<fieldset>
	...
	<table width="100%"  cellpadding="0" cellspacing="0" border="0"  align="left">
      <tr>
        <td width="396" class="style_h"><div align="left"> คำนำหน้าชื่อ
	...
	?>
	  ...
	  <tr><td width="396" height="30" class="style_h"><div align="left">เลขประจำตัวประชาชน</div></td>
        <td ><div align="left">
        ...
        <td width="208"><div align="left">
            <input name="tax_id" type="text" size="15" maxlength="31"  value="<?=$tax_id?>" class="text"/>
        </div></td>	
		</tr>
		<tr>
        <td width="396" class="style_h"><div align="left">เลขประจำตัวบัตรประกันสังคม</div></td>
        <td width="272"><div align="left">
            <input name="ss_id" type="text" size="15" maxlength="31" value="<?=$ss_id?>" class="text"/>
        </div></td>
          <td width="422" height="30" class="style_h"><div align="left">เลขบัตรข้าราชการ</div></td>
        <td ><div align="left">
            <input name="id_serv" type="text" size="15" maxlength="13" value="<?=$d[id_serv]?>" class="text" />
        </div></td>
      </tr>
      <tr>
        <td width="396" class="style_h"><div align="left">วัน เดือน ปี เกิด </div></td>
        ...
        &nbsp; พ.ศ. 
        <input name="year1" type="text" id="year1" size="5" class="text">
            </div></td>
     ...
     <tr>
        ...
        &nbsp;เดือน 
        <select name="month2" id="month2" class="text">
          <option value="01" selected>มกราคม</option>
          <option value=02>กุมภาพันธ์</option>
          <option value=03>มีนาคม</option>
          <option value=04>เมษายน</option>
        ...
        &nbsp; พ.ศ. 
        <input name="year2" type="text" id="year2" size="5" class="text">
           </div></td>
		   </tr>
	  <tr>
        <td width="396" class="style_h"><div align="left">วันเริ่มปฏิบัติราชการ</div></td>
        <td height="30" colspan="3"><div align="left">วันที่ 
        ...
        &nbsp; พ.ศ. 
        <input name="year3" type="text" id="year3" size="5" class="text">
         </div></td>
      </tr>
        	  <tr>
      
		 <td width="396" class="style_h"><div align="left">ประเภทข้าราชการ</div></td>
        <td colspan="3"><div align="left">
            <input name="type_work" type="text" size="10"  value="<?=$d[type_work]?>" class="text"/>
        </div></td>
      </tr>
      <tr>
        ...
        <td width="422" class="style_h"><div align="left">เชื้อชาติ</div></td>
        <td width="208"><div align="left">
      ...
      <tr>
        ...
        <td width="422" class="style_h"><div align="left">กรุ๊ปแลือด</div></td>
        <td width="208"><div align="left">
            <input name="blood" type="text" size="10"  value="<?=$blood?>" class="text"/>
        </div></td>
      </tr>
      <tr>
          <td width="396" class="style_h"><div align="left">ชื่อบิดา</div></td>
                <td  ><div align="left">
                    <input name="fa_name" type="text" size="15"  value="<?=$fa_name?>" class="text"/>
                </div></td>
		  <td width="422" class="style_h"><div align="left">ชื่อมารดา</div></td>
                <td  ><div align="left">
                    <input name="mo_name" type="text" size="15"  value="<?=$mo_name?>" class="text"/>
                </div></td>
        </tr>
		<tr>
	  <td width="396" class="style_h"><div align="left">สมัคร กบข. </div></td>
        <td  height="30"  colspan="3"><div align="left">
		  <input  type="radio" name="reseve" value="Y"  <? if($reseve == 'Y') echo "checked"?> class="text"/> &nbsp;&nbsp;สะสม&nbsp;&nbsp;
		    <input type="radio" name="reseve" value="N" <? if($reseve == 'N') echo "checked"?> class="text"/> &nbsp;&nbsp;ไม่สะสม&nbsp;&nbsp;
		  </div>		  </td>
	    </tr>
		   <tr>
	  <td width="396" class="style_h"><div align="left">รูปภาพ </div></td>
        <td  height="30"  colspan="3"><div align="left">
      ...
      <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="24%"><div align="left">
                    <input name="soi" type="text" size="10"   value="<?=$soi?>" class="text"/>
                </div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="19%"><div align="left">
                    <input name="zip_code"  value="<?=$zip_code?>" type="text" size="10" class="text"/>
                </div></td>
              ...
              <tr>
                ...
                <td  colspan="5"><div align="left">
                    <input name="address" type="text" size="80"  value="<?=$address?>" class="text"/>
                </div></td>
              </tr>
            </table>
            </fieldset></td>
	   ...
	   <tr>
        ...
        <td width="308"><div align="left">
            <input name="mate_name" type="text" id="mate_name" value="<?=$mate_name?>" size="20" maxlength="100"  class="text"/>
        </div></td>
		<td width="168" class="style_h" ><div align="left">สถานที่ทำงาน</div>		</td>
		<td width="324" ><div align="left">
                <input name="office" type="text" size="25" maxlength="255"value="<?=$office?>" class="text" /></div>           </td>
      </tr>
              <tr>
        <td  height="30" class="style_h"><div align="left"> ตำแหน่ง&nbsp;&nbsp; </div></td>
        <td width="308"><div align="left">
            <input name="ruck" type="text" id="ruck" value="<?=$ruck?>" size="25" maxlength="100" class="text" />
        </div></td>
		<td class="style_h" ><div align="left">เบอร์โทร</div>		</td>
		<td ><div align="left">
                <input name="tel" type="text" size="10" maxlength="255"value="<?=$tel?>" class="text" /></div>           </td>
      </tr>
            </table>
            </fieldset></td>
      </tr>

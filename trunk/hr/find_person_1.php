  ...
  <tr>
    <td  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1"  bgcolor="#F4F7F9">
 		 	<tr  class="lgBar1" >
  		  		<td  height="25" colspan="4" ><div>ค้นหาบุคคลากร นายก/รองนายก/ที่ปรึกษา/สจ.  </div></td>
  			</tr>
...
<table width="19%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="center"><a href="index.php?action=add_person_h" >เพิ่มบุคคลากร </a></td>
  </tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1" align="center"  bordercolor="#FFFFFF">
	...
	<tr  bgcolor="#60c0ff">
		<td  align="center" height="25" width="366"> ชื่อ - สกุล</td>
		<td   align="center" height="25" width="505">ข้อมูล</td>
		<td   align="center" height="25" width="397"> ตำแหน่ง	</td>
...
function find_command_show($w_id , $num){
				...
				while($rs2=mysql_fetch_array($result2)){
					...
					if($rs2[command] <>'')   $dd2 .=  "<br>&nbsp;  คำสั่งเลขที่ ".$rs2[command];

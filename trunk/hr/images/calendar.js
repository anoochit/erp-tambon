...
function showCalendar(id) {
	...
	if (calendar != null) {
		...
		var date = new Date()
		//var minYear = (date.getYear() - 2)+543, maxYear = (date.getYear() +10) + 543;
...
Calendar = function (mondayFirst, dateStr, onSelected, onClose) {
	...
	this.dragging = false;
	this.hidden = false;
	this.minYear = (date.getYear() - 2);
	this.maxYear = (date.getYear() +10) ;
	//this.minYear = (date.getYear() - 2)+543;
	//this.maxYear = (date.getYear() +10) + 543;

...
<tr>
	...
	if($_REQUEST["add_add"] != "") {
		...
		$dep_id = $_REQUEST["dep_id"];
			...
			,remark ='$remark' ,status ='อนุมัติแล้ว'
	...
	<tr>
	<td background="images/bar.gif"  align="left"height="30"  colspan="2" ><strong>หนังสือรออนุมัติ</strong></td>
	</tr>
	<tr>
	<td width="157"><div>
		กอง 
...
<tr>
	<td width="157" valign="top"><div>เผยแพร่ </div>	</td>
...
?>
	...
	<tr>
	<td width="157"><div>
		วันที่อนุมัติ  <strong><font color="#FF0000" >*</font></strong>
		</div>	</td>
	<td width="685">
...
<input type="submit" name="add_add" value=" อนุมัติ " onclick="return validate()"></td>
</tr>
	</table>
</form>
	<? }else{?>	
	...
	<tr>
	<td background="images/bar.gif"  align="left"height="25"  colspan="13" ><strong>หนังสือรออนุมัติ</strong></td>
	</tr>
	<tr>
		<td background="images/bar.gif" align="center" height="25" width="1"> <IMG src="images/nbar.gif" width="1" height="25" border="0">		</td>
		<td background="images/bar.gif" align="center" height="25" width="129"> เลขที่เอกสาร		</td>
			<td background="images/bar.gif" align="center" height="25" width="1"> <IMG src="images/nbar.gif" width="1" height="25" border="0">		</td>
		<td background="images/bar.gif" align="center" height="25" width="125"> เลขที่รับเอกสาร		</td>
		<td background="images/bar.gif" align="center" height="25" width="1"> <IMG src="images/nbar.gif" width="1" height="25" border="0">		</td>
		<td background="images/bar.gif" align="center" height="25" width="294"> เรื่อง		</td>
		<td background="images/bar.gif" align="center" height="25" width="1"> <IMG src="images/nbar.gif" width="1" height="25" border="0">		</td>
		<td background="images/bar.gif" align="center" height="25" width="100"> ลงวันที่		</td>
		<td background="images/bar.gif" align="center" height="25" width="1"> <IMG src="images/nbar.gif" width="1" height="25" border="0">		</td>
		<td  background="images/bar.gif" align="center" height="25" width="98"> วันที่รับ		</td>
		<td background="images/bar.gif" align="center" height="25" width="1"> <IMG src="images/nbar.gif" width="1" height="25" border="0">		</td>
		<td background="images/bar.gif" align="center" height="25" width="97">วันที่ส่ง		</td>
	</tr>
	<?

...
if($_REQUEST["b_submit"] != "") {
	$sql_add = "UPDATE activity SET ac_date='".date_format_sql($_REQUEST["ac_date"])."',ac_time='$ac_time',ac_detail='$topic' WHERE a_id='$ac_id' ";
...
<tr>
	...
	<tr>
		<td background="images/bar.gif" align="center" height="25" width="100%">แก้ไขปฏิทินกิจกรรม
		</td>
	</tr>
</table>
<div align="center">
<form name="borrow" action="index.php?action=edit_ac&ac_id=<?=$ac_id?>" method="post">
<table width="600">
<tr>
	<td width="150">
	วันที่
	...
	<IMG src="images/calendar.gif" width="20" height="13" border="0" alt="" onclick="popupCalender('ac_date');">
	</td>
</tr>
<tr>
	<td width="150">
	...
	<input type="text" name="ac_time_start" size="10" maxlength="10" value="<?= $ac_time_arr[0]?>"> ถึง <input type="text" name="ac_time_finish" size="10" maxlength="10" value="<?= $ac_time_arr[1]?>">
	</td>
</tr>
<tr>
	<td width="150">
	...
	<td>
	<input type="text" name="topic" size="90" maxlength="255" value="<?= $rs_d["ac_detail"]?>">
	</td>
</tr>
<tr>
	<td width="150">

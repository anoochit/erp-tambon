    ...
    <td  colspan="2" style="border: #7292B8 1px solid;"  ><table width="100%" align="center" cellspacing="1" style="border-collapse:collapse;">
      ...
      <tr>
        <td colspan="6"><table width="100%">
            <tr class="bmText">
              <td width="15%" height="30">เลขที่ใบย้าย / เบิก</td>
              <td width="35%"><div>
	...
	if($sub_id <>''){
	 ...
	 ?>
      ...
      <tr class="bmText"  bgcolor="#C1E0FF">
        <td width="69" ><div align="center"> <b><span style="font-size:9pt;"><font face="Tahoma">เลือกทั้งหมด<br />
                      <input type="checkbox" name="allbox" onClick="selectall();" >
        </font></span></b> </div></td>
        <td width="100"  align="center" height="30"><strong>วันที่เบิก</strong></td>
        <td width="194"  align="center" height="30"><strong>ชื่อครุภัณฑ์ </strong></td>
        <td width="242"  align="center" height="30"><strong>เลขครุภัณฑ์</strong></td>
...
?>
 ...
 ?></a></font></div></td>
        <td  align="center"><font size="2">&nbsp;<a href="#" onClick="javascript:window.open('show_move.php?c_id=<?=$rs["c_id"]?>','xxx','scrollbars=yes,width=650,height=400')" >รายละเอียด</a></font></td>
      </tr>
      <? 

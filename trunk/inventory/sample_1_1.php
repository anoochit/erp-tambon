...
if($Go <> ''){
		...
		$sql_order = "UPDATE receive SET 	date_receive = '".date_format_sql($date_receive)."', 
		come_in ='".$come_in."' ,paper_id ='".$paper_id."'  WHERE r_id = $r_id 
";
		echo $sql_order."<br>"; 
    ...
    <td  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			...
			<td><table name="add" cellpadding="1" cellspacing="1" border="0" bgcolor="#f4f7f9" width="100%">
			  ...
			  <tr>
                <td width="318" class="bmText_1"> วันที่ได้กรรมสิทธิ์<font color="#FF0000"></font></td>

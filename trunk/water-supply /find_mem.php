...
<tr class="bmText">
	...
	<td  class="lgBar" height="25"  >
		<div > <img src="images/Search.png" align="absmiddle"><!--<img src="PNG-32/Bar Chart.png" align="absmiddle"> -->&nbsp;&nbsp;&nbsp;ทะเบียนผู้ขอใช้บริการ</div>	</td>
	</tr>
</table>	</td>
	</tr> 
...
<tr class="lgBar">
      <td  height="28" colspan="14"><div  align="left">&nbsp;&nbsp;ข้อมูลผู้ขอใช้บริการ&nbsp;&nbsp;&nbsp;[ <a href="?action=add_mem" class="catLink1">	เพิ่มผู้ใช้ </a> ]</div></td>
          </tr>
  <tr class="bmText"  bgcolor="#DEE4EB">
		...
		<td width="21%"  height="31" align="center"><strong>ชื่อ - สกุล</strong></td>
		 ...
		 <td width="11%"  align="center"><strong>เลขมาตร</strong></td>
...
<td  align="center"><a href="?action=view_detail_mem&mcode=<?=$rs_1[MCODE]?>&MNO=<?=$rs_1[MNO]?>" >แก้ไข / ยกเลิก </td></tr></a>
 <? 
	}
?>
        </table>
...
<? /* สร้างปุ่มย้อนกลับ */
if($Prev_Page) 
echo " <a href='?action=find_mem&search=$search&Page=$Prev_Page&mcode_1=$mcode_1&mcode_2=$mcode_2&name=$name&surn=$surn&HOCODE=$HOCODE&z_id=$z_id'><< ย้อนกลับ </a>";
...
/*สร้างปุ่มเดินหน้า */
if($Page!=$Num_Pages)
echo "<a href ='?action=find_mem&search=$search&Page=$Next_Page&mcode_1=$mcode_1&mcode_2=$mcode_2&name=$name&surn=$surn&HOCODE=$HOCODE&z_id=$z_id'> หน้าถัดไป>> </a>";
?>
<br />
</font>
</center>

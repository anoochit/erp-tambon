...
<form name="f12" method="post"  action=""   >
  ...
  <table width="100%" cellspacing="0"  cellpadding="0" border="0"  style="border-collapse:collapse;">
			 <tr class="body1">
            <td  height="31">&nbsp;เรื่อง&nbsp;แจ้งให้ชำระค่าน้ำประปา</td>
            </tr>
        </table>		
  </td></tr>
			 <tr class="body1">
  ...
  <tr class="body1" >
        <td  height="40" colspan="14"><div  align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ตามที่ท่านได้ขอใช้น้ำประปากับทาง<? echo check_start_name( )?>  การประปา<? echo check_start_name( )?>ได้ดำเนินการตรวจสอบพบว่าท่านค้างชำระเงินค่าน้ำประปาดังนี้</div></td>
      </tr>
  <tr>
	...
	<table width="70%" align="center" cellspacing="0"  cellpadding="0" border="1" bordercolor="#999999">
      <tr class="body1" >
        ...
        <td width="16%"  align="center"><strong>จำนวนหน่วย</strong></td>
...
<?
   $sql_1 =" Select  b.MCODE,pren,name,surn,HNO1,HNO,rec_status,
    ...
    Where b.mem_id = m.mem_id and rec_status = 'ค้างชำระ' and b.MCODE = '" .$mcode."' 
	order by rec_date ";
...
<tr class="body1">
       ...
       <td  align="center">&nbsp;<? echo mounth2($rs_1[monthh])." ".$Yr;?></td>
		<td  align="center">&nbsp;<? echo number_format($rs_1[amount]); ?></td>
	...
	<tr class="body1">
	  <td height="34">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รวม<u>&nbsp;&nbsp;&nbsp;<strong><? echo number_format($i) ?></strong>&nbsp;&nbsp;&nbsp;</u>เดือน  เป็นจำนวนเงิน<u>&nbsp;&nbsp;&nbsp;<strong><? echo number_format($total,2) ?></strong>&nbsp;&nbsp;&nbsp;</u>บาท (<u>&nbsp;<strong><? echo num_to_char($total) ?></strong>&nbsp;</u>)นั้น </td>
	</tr>
	<tr class="body1">

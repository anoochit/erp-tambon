...
$stotal6 = 0;
$stotal7 = 0;
$sql_1="select mid(mcode,1,2) as mcode, honame, sum(sum_m)as stotal  from meter, house where rec_status is not null and rec_status <> 'ยกเลิก' 
...
while($rs_1=mysql_fetch_array($result_1)){
		    //////////////////////////////////หายอดเงินที่เก็บได้ในเดือน///////////////////////////////////
				...
				while($rs2=mysql_fetch_array($result2)){
					...
					$sql3=" select  if(sum(sum_m) is null,'0',sum(sum_m)) as stotal3 from house left join meter on hocode = mid(mcode,1,2)
 ...
 <tr class="body1" bgcolor="<? echo $bg?>" onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
		...
		<td  height="25"   align="center">&nbsp;<? echo number_format($rs3[stotal3],2); ?></td>
		<td  height="25"  align="center">&nbsp;<? echo number_format($rs_1[stotal],2); ?></td>
        <td  align="center">&nbsp;<? echo number_format($rs3[stotal3]+$rs_1[stotal],2); ?> </td>
	    <td  height="25"   align="center">&nbsp;<? echo number_format($SumMtotal,2); ?></td>
		<td  height="25"  align="center">&nbsp;<? echo number_format(($rs3[stotal3]+$rs_1[stotal])-$SumMtotal,2); ?></td>
      ...
      <tr class="body1" bgcolor="#DEE4EB"  onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe' " onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = '' ">
        ...
        <td  height="25"  align="center">&nbsp;<strong><?=number_format($stotal3,2)?></strong></td>
        <td  align="center">&nbsp;<strong><?=number_format($stotal,2)?></strong></td>
        <td  align="center">&nbsp;<strong><?=number_format($stotal4,2)?></strong></td>
        <td  align="center">&nbsp;<strong><?=number_format($stotal5,2)?></strong></td>
        <td  align="center">&nbsp;<strong><?=number_format($stotal6,2)?></strong></td>

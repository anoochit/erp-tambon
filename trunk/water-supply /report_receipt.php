...
while($rs_1=mysql_fetch_array($result_1)){
	 ...
	 <tr class="bmText" bgcolor="<? echo $bg?>" onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
        ...
        <td  align="center"><font size="1">&nbsp;<? echo Find_mem($rs_1[hocode],$year,$month); ?></font></td>
        <td  align="center"><font size="1">&nbsp;<?=number_format($rs2[stotal1],2);?></font></td>
		  </tr>
			<?
			   }}}}
			   ?>
      <tr class="bmText" bgcolor="#DEE4EB" <? echo $bg?>" onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
        <td  height="25"  align="center">&nbsp;<strong>รวม</strong></td>
        <td  height="25"   align="left"></td>
        <td  height="25"  align="center"></td>
        <td  align="center">&nbsp;</td>
        <td  align="center">&nbsp;<?=number_format($sumtotal2)?></td>
...
<div align="center">
<input  type="button" name="print" value=" พิมพ์ "  onclick="window.open('report3.php?month=<?=$month?>&year=<?=$year?>&year2=<?=$Yr?>&Sumbill=<?=number_format($sumtotal2)?>&SumMoney=<?=number_format($sumtotal1)?>')"/ class="buttom">
</FONT></center></div> 
</body>
</html>
<?

...
$sql_1="select hocode,honame, if(sum(total)is null,'0',sum(total)/".MONEY().") as total1 , if(sum(total) is null,'0',sum(total)) as total2 
...
?>
  ...
  <table width="100%" cellspacing="0"  cellpadding="0" border="0"  style="border-collapse:collapse;">
			 <tr>
            <td  height="42">&nbsp;รายงานสรุปค่าธรรมเนียมน้ำประปาค้างชำระประจำเดือน <strong>
              <?=mounth3($monthh)?>&nbsp;<?=$year?>
            </strong>
<div align="center" class="style1"></div></td>
  ...
  <tr>
    <td  colspan="2"   ><table width="100%" align="center" cellspacing="0"  cellpadding="0" border="1" bordercolor="#666666">
        ...
        <td width="10%"  height="31" align="center"><strong>หมู่ที่</strong></td>
        <td width="40%"  height="31" align="center"><strong>ชื่อหมู่บ้าน</strong></td>
...
while($rs_1=mysql_fetch_array($result_1)){
	...
	elseif( $i%2 ==1) $bg ='#ffffff';
      ...
      <tr class="body1" bgcolor="<? echo $bg?>" onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
        ...
        <td  height="25"  align="center">&nbsp;<? echo Find_mem($rs_1[hocode],$year,$month); ?></td>

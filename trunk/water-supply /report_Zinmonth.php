...
<table  width="98%" border="0" align="center" cellpadding="0" cellspacing="0"  bordercolor="#000000" >
  <tr>
	...
	<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0"  bordercolor="#000000">
      <tr class="lgBar">
        <td  height="28" colspan="14"  ><div  align="left">&nbsp;&nbsp;<strong>รายงานสรุปยอดเก็บได้ในเดือน [ป.32]&nbsp;&nbsp;หมู่ที่ : <?=$HOCODE." " .$honame?>&nbsp;ประจำเดือน : <?=mounth3($month)?>&nbsp;<?=$year?>
        </strong> </div></td>
      </tr>
      <tr class="bmText"  >
...
$sql1="select  p_date,sum(sum_m)as stotal,z_id from meter, zone
 where rec_status is not null and rec_status <> 'ยกเลิก' ";
...
and rec_status is not null and rec_status <> 'ยกเลิก'   and z_id = mid(mcode,3,1) and hocode = mid(mcode,1,2)
...
and z.hocode = mid(mcode,1,2) and rec_status is not null and rec_status <> 'ยกเลิก'  and p_date = '" .$rs1[p_date]. "'
...
from (house h,zone z)left join meter on z_id = mid(mcode,3,1) 
and z.hocode = mid(mcode,1,2) and rec_status is not null and rec_status <> 'ยกเลิก' 

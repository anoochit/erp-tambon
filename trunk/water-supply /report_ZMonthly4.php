  ...
  <tr>
    <td  colspan="2" style="border: #7292B8 1px solid;"  ><table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
      ...
      <tr class="bmText"  bgcolor="#DEE4EB">
        ...
        <td width="14%"  height="31" align="center"><strong>ชื่อเขต</strong></td>
...
?>
      <tr class="bmText" bgcolor="<? echo $bg?>" onMouseOver= "if (typeof(this.style) != 'undefined') this.style.backgroundColor = '#b9c9fe'" onMouseOut="if (typeof(this.style) != 'undefined') this.style.backgroundColor = ''">
        ...
        <td  align="center"><font size="1">&nbsp;
         ...
         <td  align="center"><a href="report_Zremain.php?hocode=<?=$HOCODE?>&honame=<?=$rs_1[honame]?>&month=<?=$month?>&year=<?=$year?>&ZID=<?=$rs_1[z_id]?>&ZName=<?=$rs_1[z_name]?> " target="_blank">รายละเอียด</a></td>
      </tr>
      <? 
	}}
?>
...
<div align="center">
<input  type="button" name="print" value=" พิมพ์ "  onclick="window.open('report19.php?HOCODE=<?=$HOCODE?>&honame=<?=$honame?>&month=<?=$month?>&year=<?=$year?>')"/ class="buttom">
</FONT></center></div> 
</body>
</html>

...
if($OK <> '' ){
			...
			<script language="JavaScript">
							...
							$sql_update = "update receive  set rec_status ='ค้างชำระ' , ";
						...
						<?			
							...
							$sql_update = "update receive  set rec_status ='ยกเลิก' ,  ";
							$sql_update .=  " p_date ='1111-11-11'  ";
							$sql_update .=  "  where mcode = '" .$MCODE. "' and   ";
							$sql_update .=  " rec_id ='" .$rec_id_old. "'";
							echo "\$sql_update  ".$sql_update."<br>";
...
<table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" >
      <tr> 
        <td  colspan="2" style="border: #7292B8 1px solid;"  >
          <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr class="lgBar" >
			   <td  height="32">แก้ไขข้อมูลใบเสร็จรับเงิน</td> 
            </tr>
            <tr>
  ...
  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
              ...
              <option value="3" <? if($type =='3') echo "selected"?> >ยกเลิกใบเสร็จ </option>
            </select>
		    </div></td>
			</tr>
	  <tr ><td colspan="2" background="images/hdot2.gif"> </td></tr> 
		  ...
		  <tr class="bmText" height="25">
			...
			$rs_1=mysql_fetch_array($result_1);
			  ?>
  <tr class="bmText" >
    <td width="16%" height="25"><strong>&nbsp;&nbsp;เลขทะเบียน</strong></td>
  ...
  <tr class="bmText" >
     <td width="16%" height="25"><strong>&nbsp;&nbsp;ชื่อ</strong></td>
   ...
   ?>" size="10"class="text"    /><input type="hidden" name="rec_date_old" value="<?=$rs_1[rec_date]?>" size="10"class="text"    /></td>
      ...
      <tr ><td colspan="4" background="images/hdot2.gif"> </td></tr> 
  <tr class="bmText" >
       <td width="16%" height="25"><strong>&nbsp;&nbsp;บ้านเลขที่</strong></td>
    ...
    <td>&nbsp;<input type="text" name="name" value="<? echo $rs_1[rec_status]?>" size="10"class="text"    /></td>
      ...
      <tr ><td colspan="4" background="images/hdot2.gif"> </td></tr> 
  <tr class="bmText" >
       <td width="16%" height="25"><strong>&nbsp;&nbsp;จำนวนเงิน</strong></td>

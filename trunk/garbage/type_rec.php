...
<?
//-----------แสดงข้อมูล-------------------
    $sql=" Select  trcode,trname,cost from type_rece  order by trcode ";
		$result=mysql_query($sql);
    ...
    <td height="30"  colspan="6"  style="border: #000000 1px solid;">
      <div align="left">&nbsp;&nbsp;&nbsp;[ <a href="?action=add_type_rec" class="catLink1">	เพิ่มปริมาณ</a>]</td> 
	 </tr>
     <tr class="lgBar" bgcolor="#99CCFF">					 
	<td width="16%" height="28"  align="center" style="border: #000000 1px solid;" > รหัส    </td>
	   <td width="51%" style="border: #000000 1px solid;"  align="center">ปริมาณขยะ      </td>
<td width="22%" style="border: #000000 1px solid;"  align="center">จำนวนเงิน     </td>
...
<td  align="center" style="border: #000000 1px solid;" >&nbsp;&nbsp;<?=$d[trcode]?></td>
	   ...
	   <td    align="center"style="border: #000000 1px solid;" ><?=number_format($d[cost])?>&nbsp;&nbsp;</td>

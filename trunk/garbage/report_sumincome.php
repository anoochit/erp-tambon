  ...
  <tr>
    <td  colspan="2" style="border: #7292B8 1px solid;"  ><table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
      ...
      <tr class="bmText"  bgcolor="#DEE4EB">
        ...
        <td width="12%"  height="31" align="center"><strong>จำนวนเงินในตอน</strong></td>
        <td width="13%"  align="center"><strong>จำนวนเงินสำนักงาน(คงค้าง)</strong></td>
        <td width="13%"  align="center"><strong>รวมเป็นเงิน</strong></td>
      </tr>
<?
if($search <>'')
$stotal1 = 0;

...
<script language="JavaScript" type="text/javascript">
	...
	function validate(theForm) 
	{
           ...
           return false;
		   	    ...
		   	    if (  document.add_user.cost.value=='' || document.add_user.cost.value==' ' )
           {
           alert("กรุณากรอกจำนวนเงิน");
           document.add_user.cost.focus();           
           return false;
           }
...
if($save_add <>''){
	...
	$query=" INSERT INTO type_rece (trcode, trname ,cost )
		 VALUES ('$trcode','$trname' ,'$cost' )";
 ...
 <tr >
    <td  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr class="lgBar">
  		  		<td  height="25" colspan="2"><div>&nbsp;&nbsp;&nbsp;เพิ่มข้อมูลประเภทถังขยะ</div></td>
  			</tr>
...
<tr class="bmText">
  ...
  <td align="left">&nbsp;&nbsp;
	  <input  type="text" name="cost" value="<?=$cost?>" size="5" maxlength="7"  /></td>
</tr>
  <tr><td colspan="2" background="images/hdot2.gif"> </td></tr>
<tr>

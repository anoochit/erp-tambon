...
<tr class="lgBar">
  ...
  <tr class="bmText"  bgcolor="#DEE4EB">
		...
		<td width="24%"  height="31" align="center"><strong>ชื่อ - สกุล</strong></td>
         <td width="10%"  align="center"><strong>บ้านเลขที่</strong></td>
		 <td width="10%"  align="center"><strong>เลขที่ใบเสร็จ</strong></td>
		 <td width="15%"  align="center"><strong>วันที่ออกใบเสร็จ</strong></td>
		 <td width="10%"  align="center"><strong>จำนวนเงิน</strong></td>
         <td width="13%"  align="center"><strong>ประจำเดือน</strong></td>
          </tr>
		   <?
if($search <>''){
$mname = "" ;
$mcode1 = "";
		...
		if($mcode_1 <>'') $sql_1 .="  	and mid(b.MCODE,1,2) = '" .$mcode_1."'  ";
		if($mcode_2 <>'') $sql_1 .="  	and mid(b.MCODE,4) = '" .$mcode_2. "'  ";

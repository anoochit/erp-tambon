...
if($save_add <>''){
	...
	$query=" INSERT INTO type_mem (tmcode, tmname) VALUES ('$tmcode','$tmname')";
 ...
 <tr >
    <td  colspan="2" style="border: #7292B8 1px solid;"  >
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
 		 	<tr class="lgBar">
  		  		<td  height="25" colspan="2"><div>&nbsp;&nbsp;&nbsp;เพิ่มข้อมูลประเภทผู้ขอใช้บริการ</div></td>
  			</tr>
...
<tr class="bmText">
  <td a align="right" width="31%"  >ประเภท</td>
  <td align="left">&nbsp;&nbsp;

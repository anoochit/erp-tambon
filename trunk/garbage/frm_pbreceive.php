...
$sql_ex  .=  "  and m2.mcode = r.mcode and m2.status = 'ปกติ' and rec_status <> 'ยกเลิก'   ";
if($nsurn <> ''){ 
...
<table width="100%" align="center" cellspacing="1"  cellpadding="1" border="0">
  <tr class="bmText"  bgcolor="#DEE4EB">
		...
		<td width="23%"  height="31" align="center"><strong>ชื่อ - สกุล</strong></td>
		<td width="11%"  height="31" align="center"><strong>บ้านเลขที่</strong>		</td>
        <td width="11%"  align="center"><strong>เลขที่ใบเสร็จ</strong></td>
		<td width="14%"  align="center"><strong>วันที่ออกใบเสร็จ</strong></td>
         <td width="11%"  align="center"><p><strong>จำนวนเงิน</strong></p></td>
